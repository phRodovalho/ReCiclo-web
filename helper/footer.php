        ...
        <div class="footer-top">
            ...
            <div class="container">
                ...
                <div class="row footer-newsletter justify-content-center">
                    <div class="col-lg-6">
                        <form action="" method="post">
                            <input type="email" name="email" placeholder="Digite seu e-mail"><input type="submit" value="Cadastrar">
                        </form>
                    </div>
                </div>
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.linkedin.com/in/phelipe-rodovalho-ufu/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
                </div>
    ...
    <!-- Vendor JS Files -->
    <script src="/ReCiclo/view/assets/vendor/purecounter/purecounter.js"></script>
    <script src="/ReCiclo/view/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="/ReCiclo/view/assets/vendor/glightbox/js/glightbox.min.js"></script>
    <script src="/ReCiclo/view/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
    <script src="/ReCiclo/view/assets/vendor/swiper/swiper-bundle.min.js"></script>
    <script src="/ReCiclo/view/assets/vendor/php-email-form/validate.js"></script>

    <!-- Template Main JS File -->
    <script src="/ReCiclo/view/assets/js/main.js"></script>