        ...
        <ul>
            ...
            if (isset($_SESSION['nameUser']) == true) { //se tem usuário setado
                if ($_SESSION['userType'] == 'P') { //se usuario é padrão não habilita crud de admin
                    echo '<li><a class="getstarted scrollto"><span class="glyphicon glyphicon-user"></span> ' . $_SESSION['nameUser'] . '</b></a></li>';
                    echo '<li><a class="getstarted scrollto" href="logout.php"><span class="glyphicon glyphicon-log-out"></span> <b>Logout</b></a></li>';
                } else { //usuário admin
                    echo '<li><a class="getstarted scrollto" href="adminUser.php"><span class="glyphicon glyphicon-user"></span> ' . $_SESSION['nameUser'] . '</b></a></li>';
                    echo '<li><a class="getstarted scrollto" href="logout.php"><span class="glyphicon glyphicon-log-out"></span> <b>Logout</b></a></li>';
                }
            } else echo '<li><a class="getstarted scrollto" href="login.php"><span class="glyphicon glyphicon-user"></span> Login ou Crie sua Conta </a></li>';
            ?>
        </ul>
